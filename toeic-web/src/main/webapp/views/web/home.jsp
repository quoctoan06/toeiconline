...
<div class="row feature-box">
    ...
    <div class="span4">
        ...
        <a href="<c:url value="/danh-sach-bai-huong-dan-nghe.html"/>">Read More &rarr;</a>
    </div>

    <div class="span4">
        <img src="img/icon2.png">
        <h2><fmt:message key="label.exercise.listening" bundle="${lang}"/></h2>
        <p>
            Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
            aliqua.
        </p>
        <c:url var="listListeningExercise" value="/danh-sach-bai-tap-nghe.html">
            <c:param name="pojo.type" value="listening"/>
        </c:url>
        <a href="${listListeningExercise}">Read More &rarr;</a>
    </div>
