                                    ...
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            ...
                                            <a flag="info" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold" href="${addUrl}"
                                               data-toggle="tooltip" title="<fmt:message key='label.guideline.listen.add' bundle='${lang}'/>">
                                                        <span>
                            ...
                            <fmt:bundle basename="ApplicationResources">
                                <display:table id="tableList" name="items.listResult" partialList="true" size="${items.totalItems}"
                                    ...
                                    <display:column title="<fieldset class='form-group'>
                                        ...
                                        <fieldset>  <%--checkList sẽ tự động map với attribute checkList[] trong AbstractCommand--%>
                                    ...
                                    <display:column headerClass="col-actions" titleKey="label.action">
                                        ...
                                        <a class="btn btn-sm btn-primary btn-edit" href="${editUrl}" data-toggle="tooltip" title="<fmt:message key='label.guideline.listen.edit' bundle='${lang}'/>">
                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                        </a>
                                        <a class="btn btn-sm btn-danger btn-cancel" data-toggle="tooltip" title="<fmt:message key='label.guideline.listen.delete' bundle='${lang}'/>">
...
<script>
    ...
    function warningBeforeDelete() {
        showAlertBeforeDelete(function () {     // showAlertBeforeDelete(callback)
