...
<script type="text/javascript">
    function showAlertBeforeDelete(callback) {  // callback là biến hàm sẽ được gọi khi nhấn Confirm
        swal({  // sweet alert, nếu chọn nút Confirm thì return true, còn nếu chọn nút Cancel thì return null
            title: "Xác nhận xoá",
            text: "Bạn có chắc chắn xoá những dòng đã chọn",
            type: "warning",
            showCancelButton: true,     // By default, only the confirm button is shown
            confirmButtonText: "Xác nhận",
            cancelButtonText: "Huỷ bỏ",
            confirmButtonClass: "btn btn-success",
            cancelButtonClass: "btn btn-danger"
        }).then(function (isConfirm) {  // biến kiểm tra
            if (isConfirm) {    // nếu true, tức xác nhận
                callback();     // thì ta gọi hàm muốn thực thi
            }
        });
    }
</script>
